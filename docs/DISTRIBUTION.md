...
Per-channel status for Awesome Enterprise Architect under Release Repo Standard RR-B-36.
...
| Org catalogue (labs.jgsystemsconsulting.com) | site entry | planned | Add products.yml entry when public or org-visible Labs policy allows. | 2026-09-18 |
...
Multi-page assessment: one HTML landing plus README as deep content; nothing justifies a third page.
