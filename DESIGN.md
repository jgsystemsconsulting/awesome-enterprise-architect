# DESIGN.md: Awesome Enterprise Architect

## Product

**Name:** Awesome Enterprise Architect  
**Purpose:** Public-domain curated index of Sparx Systems Enterprise Architect product resources: official docs, add-ins and MDG packs, scripting and API, tutorials, books, and sample models. Not a general enterprise-architecture (TOGAF/ArchiMate) index.  
**Primary users:** MBSE and systems-engineering practitioners who use Sparx EA.  
...
- Optional: simple monochrome Sparx EA-adjacent diagram only if it earns space; default is typography + list  
